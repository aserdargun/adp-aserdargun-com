...
The application has no runtime API, database or server-side secrets. No custom domain or DNS records are created by this workflow. Azure's generated hostname is the production endpoint for this delivery.
